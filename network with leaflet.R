...
mun.inter<- coordMunicipal %>% 
  dplyr::filter(code_muni %in% c('1100023','1100122','1100205','1200401','1200203','1302405','1302504','1301902','1304203',
                  ...
                  mutate(tipo = c("centroA","centroB","centroA","centroB","centroA","centroB","centroA","centroA","centroA",
                                  "centroA","centroB","centroA","centroB","centroA","centroB","centroA","centroA","centroA",
                                  "centroA","centroB","centroA","centroB","centroA","centroB","centroA","centroA","centroA",
                                  "centroA","centroB","centroA","centroB","centroA","centroB","centroA"))
...
network <- network[c(1:3,9:12,18:20)]
